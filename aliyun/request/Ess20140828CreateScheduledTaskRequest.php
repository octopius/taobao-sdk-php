 ...
 */
class Ess20140828CreateScheduledTaskRequest
{
	/** 
	 * 定时任务的描述信息
长度限制在2~200个英文字符，可以支持中文。（中英文长度一样）
	...
	/** 
	 * 默认600秒
当前正在发生伸缩活动或者伸缩组已被停止时，导致错过了定时任务，在LaunchExpirationTime内，系统会自动重试定时触发，否则放弃本次定时触发
...
默认为True
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->scheduledAction,"scheduledAction");
	}
