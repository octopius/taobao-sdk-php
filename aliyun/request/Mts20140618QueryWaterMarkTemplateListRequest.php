<?php
/**
 * TOP API: mts.aliyuncs.com.QueryWaterMarkTemplateList.2014-06-18 request
 * 
 * @author auto create
 * @since 1.0, 2015-01-20 12:44:20
 */
class Mts20140618QueryWaterMarkTemplateListRequest
{
	/** 
	 * 模板ID列表，用逗号分隔
	 **/
	...
	public function setWaterMarkTemplateIds($waterMarkTemplateIds)
	{
		...
		$this->apiParas["WaterMarkTemplateIds"] = $waterMarkTemplateIds;
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->waterMarkTemplateIds,"waterMarkTemplateIds");
	}
