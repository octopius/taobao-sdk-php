<?php
/**
 * TOP API: ocs.aliyuncs.com.ModifyInstanceAttribute.2014-10-01 request
 * 
 * @author auto create
 * @since 1.0, 2015-01-20 12:44:20
 */
class Ocs20141001ModifyInstanceAttributeRequest
{
	/** 
	 * (全局唯一);16位字符串
	 **/
...
由字母、数字或下划线组成，长度为6~32位，字母区别大小写。
	...
	{
		return "ocs.aliyuncs.com.ModifyInstanceAttribute.2014-10-01";
	}
