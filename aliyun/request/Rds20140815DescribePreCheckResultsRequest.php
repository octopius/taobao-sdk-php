<?php
/**
 * TOP API: rds.aliyuncs.com.DescribePreCheckResults.2014-08-15 request
 * 
 * @author auto create
 * @since 1.0, 2015-01-20 12:44:20
 */
class Rds20140815DescribePreCheckResultsRequest
{
	/** 
	 * 实例名
	 **/
	...
	public function setPreCheckId($preCheckId)
	{
		...
		$this->apiParas["PreCheckId"] = $preCheckId;
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->preCheckId,"preCheckId");
	}
