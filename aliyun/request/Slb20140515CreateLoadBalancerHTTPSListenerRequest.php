<?php
/**
 * TOP API: slb.aliyuncs.com.CreateLoadBalancerHTTPSListener.2014-05-15 request
 * 
 * @author auto create
 * @since 1.0, 2015-01-20 12:44:20
 */
class Slb20140515CreateLoadBalancerHTTPSListenerRequest
{
	/** 
...
取值：1-10<br /> 支持最大值为：10<br /> 支持最小值为：1
	...
	public function setServerCertificateId($serverCertificateId)
	{
		...
		$this->apiParas["ServerCertificateId"] = $serverCertificateId;
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->serverCertificateId,"serverCertificateId");
